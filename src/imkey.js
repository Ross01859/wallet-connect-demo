import ImKeyProvider from "../lib/imkeyProvider";
console.log(ImKeyProvider)
...
const imkeyProvider = new ImKeyProvider({
  infuraId: "fecc9e786e914b85bc8dac9f8ab0952f",
  chainId: 4,
  headers: {
    "": ""
  }
...
imkeyProvider.on("disconnect", (code, reason) => {
...
//   web3.eth
//     .getBalance("0x5a7F6712E07dc932C4516081b149d2Bb1FeaE07f")
//     .then(console.log);
// });
